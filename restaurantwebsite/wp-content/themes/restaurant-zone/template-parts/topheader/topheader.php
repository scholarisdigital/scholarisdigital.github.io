				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<?php if(get_theme_mod('restaurant_zone_phone_number_info') != ''){ ?>
							<p><i class="<?php echo esc_html( get_theme_mod('restaurant_zone_phone_number_icon') ); ?>"></i><?php echo esc_html(get_theme_mod('restaurant_zone_phone_number_info','')); ?></p>
						<?php }?>
					</div>
					<div class="col-lg-6 col-md-6">
						<?php if(get_theme_mod('restaurant_zone_email_info') != ''){ ?>
							<p><i class="<?php echo esc_html( get_theme_mod('restaurant_zone_emails_icon') ); ?>"></i><?php echo esc_html(get_theme_mod('restaurant_zone_email_info','')); ?></p>
						<?php }?>
					</div>
				</div>
			</div>
